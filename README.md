...
local Window = OrionLib:MakeWindow({Name = "sVortex hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "sVortex hub"})
...
W:AddLabel("[+] sVortex hub is HERE!")
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "sVortex hub(Noitification)",
